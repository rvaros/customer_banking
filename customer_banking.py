...
def main():
    ...
    savings_interest = float(input("Set your savings interest rate: "))    
    savings_maturity = int(input("Set length of months for your savings: "))
    ...
    # ADD YOUR CODE HERE
    cd_balance = float(input("\nSet your initial CD balance: "))
    cd_interest = float(input("Set your CD interest rate: "))
    cd_maturity = int(input("Set length of months for your CD account: "))
